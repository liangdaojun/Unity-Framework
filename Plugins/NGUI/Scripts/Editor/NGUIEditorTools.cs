...
public static class NGUIEditorTools
{
	...
	/// </summary>
	static public bool DrawSpriteField(UIAtlas atlas, string spriteName, SpriteSelector.Callback callback,
		params GUILayoutOption[] options)
	{
		if (atlas.GetSprite(spriteName) == null)
			spriteName = "";
	...
	/// Draw a sprite selection field.
	/// </summary>
	static public void DrawSpriteField(string label, SerializedObject ob, string spriteField,
		params GUILayoutOption[] options)
	{
	...
	/// Draw a sprite selection field.
	/// </summary>
	static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas,
		SerializedProperty sprite, params GUILayoutOption[] options)
	{
	...
	/// </summary>
	static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas,
		SerializedProperty sprite, bool removable, params GUILayoutOption[] options)
	{
	...
	/// </summary>
	static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas,
		SerializedProperty sprite, float width, bool padded, bool removable, params GUILayoutOption[] options)
	{
	...
	/// Convenience function that displays a list of sprites and returns the selected value.
	/// </summary>
	static public void DrawAdvancedSpriteField(UIAtlas atlas, string spriteName, SpriteSelector.Callback callback,
		bool editable,
		params GUILayoutOption[] options)
	{
	...
	/// </summary>
	static public GameObject previousSelection
	{
	...
	/// Draw a list of fields for the specified list of delegates.
	/// </summary>
	static public void DrawEvents(string text, Object undoObject, List<EventDelegate> list, string noTarget,
	...
	/// <summary>
	/// Helper function that draws a serialized property. // ----Liang 这里返回 SP 并没有使用；
	/// </summary>
	...
	/// <summary>
	/// Helper function that draws a serialized property.  // --------Liang 这里调用序列化的属性，进行 GUI的绘制；
	/// </summary>
	static public SerializedProperty DrawProperty(string label, SerializedObject serializedObject, string property,
		bool padding, params GUILayoutOption[] options)
	{
        // ----Liang  序列化物体通过属性名查找一个序列化的属性；这里的关键是怎样确定确定属性的类型， 
        
        // SerializedProperty 里封装了各种基类型；

		SerializedProperty sp = serializedObject.FindProperty(property);

		if (sp != null)
		{
			if (NGUISettings.minimalisticLook) padding = false; //  读取 Editor 的偏好设置；

			if (padding) EditorGUILayout.BeginHorizontal();

            // -----Liang 因为 UnityEngine 和 UnityEidtor 里的变量是不能公用的，所以用这种方式来绘制属性；
	...
	/// Helper function that draws a compact Rect.
	/// </summary>
	static public void DrawRectProperty(string name, SerializedObject serializedObject, string field, float labelWidth,
		float spacing)
	{
		if (serializedObject.FindProperty(field) != null)
		{
