...
public static class NGUIContextMenu
{
	...
	{
		NGUISettings.PasteWidget(command.context as UIWidget, true);
	}

	[MenuItem("CONTEXT/UIWidget/Paste Widget Style")]
	static void PasteStyle2(MenuCommand command)
	{
		NGUISettings.PasteWidget(command.context as UIWidget, false);
	}
	...
	{
		NGUIHelp.Show(typeof (UI2DSprite));
	}
