...
public class UIPanelInspector : UIRectEditor
{
	...
	public void OnSceneGUI()
	{
		...
		UIWidget.Pivot pivotUnderMouse = UIWidgetInspector.GetPivotUnderMouse(handles, e, resizable, true,
			ref actionUnderMouse);
	...
	protected override bool ShouldDrawProperties()
	{
		...
		if (NGUIEditorTools.DrawHeader("Advanced Options"))
		{
			...
			bool off = EditorGUILayout.Toggle("Offset", mPanel.anchorOffset && mPanel.GetComponent<UIRoot>() == null,
			...
			if (stat)
			{
				EditorGUILayout.HelpBox(
					"Only mark the panel as 'static' if you know FOR CERTAIN that the widgets underneath will not move, rotate, or scale. Doing this improves performance, but moving widgets around will have no effect.",
					MessageType.Warning);
			}
