...
public class UILabel : UIWidget
{
    ...
    // Add one property to control it. line 852 has it's Get,Set  -->> Liang 

    //[HideInInspector] [SerializeField] bool mControled=false;
   ...
   /* /// <summary>
    ///  Whether this label can be controled or not
    /// </summary>

    public bool Controled
    {
        get { return  mControled; }

        set { mControled = value; }
    }*/
